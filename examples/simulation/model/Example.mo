model Example
  ...
  Deltares.ChannelFlow.SimpleRouting.Storage.Storage storage(Q_release = PI_control, V(nominal=4e5)) annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
